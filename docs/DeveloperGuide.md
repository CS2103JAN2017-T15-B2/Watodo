...
`Main` has only one class called [`MainApp`](../src/main/java/watodo/MainApp.java). It is responsible for,
...
Person in charge: Min Hui

<img src="images/UiClassDiagram.png" width="800"><br>
_Figure 2.2.1 : Structure of the UI Component_

**API** : [`Ui.java`](../src/main/java/watodo/ui/Ui.java)
...
The `UI` component uses JavaFx UI framework. The layout of these UI parts are defined in matching `.fxml` files
 ...
 For example, the layout of the [`MainWindow`](../src/main/java/watodo/ui/MainWindow.java) is specified in
...
Persons in charge: Wentong, Oguz, He Xing Darius

<img src="images/LogicClassDiagram.png" width="800"><br>
_Figure 2.3.1 : Structure of the Logic Component_

**API** : [`Logic.java`](../src/main/java/watodo/logic/Logic.java)
...
**API** : [`Model.java`](../src/main/java/watodo/model/Model.java)
...
**API** : [`Storage.java`](../src/main/java/watodo/storage/Storage.java)
...
2. **Non-GUI Tests** - These are tests not involving the GUI. They include,
   1. _Unit tests_ targeting the lowest level methods/classes. <br>
      e.g. `watodo.commons.UrlUtilTest`
   2. _Integration tests_ that are checking the integration of multiple code units
     (those code units are assumed to be working).<br>
      e.g. `watodo.storage.StorageManagerTest`
   3. Hybrids of unit and integration tests. These test are checking multiple code units as well as
      how the are connected together.<br>
      e.g. `watodo.logic.LogicManagerTest`
