...
import seedu.address.model.task.UniqueList;
import seedu.address.model.task.UniqueList.DuplicateTaskException;
...
public class TaskManager implements ReadOnlyTaskManager {
    ...
    private final UniqueList tasks;
...
//// list overwrite operations
    ...
    public void setTask(List<? extends ReadOnlyTask> tasks)
...
//// task-level operations
     ...
     */
    public void addTask(TaskManager p) throws UniqueTaskList.DuplicateTaskException {
     ...
     * @see #syncMasterTagListWith(TaskManager)
     *
    ...
    public void updateTask(int index, ReadOnlyTask editedReadOnlyTask)
        ...
        TaskManager editedTask = new TaskManager(editedReadOnlyTask);
     ...
     */
    private void syncMasterTagListWith(TaskManager task) {
